...
<qgis version="1.7.0-Wroclaw" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties/>
  <displayfield>layer_id</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype type="0" name="layer_id"/>
    <edittype type="0" name="main_from"/>
  </edittypes>
  <editform></editform>
